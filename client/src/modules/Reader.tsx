...
// components
import LoadingView from '@/components/ui.custom/ebook/LoadingView';
// utils
import { debounce, timeFormatter } from '@/utils/ebook.utils';
// styles
import viewerDefaultStyles from './viewerStyle';
// types
import { ReactViewerProps, ViewerRef } from '@/types/reader';
import {Book as BookType, BookStyle, BookOption } from '@/types/ebook.d';
    ...
    const onResize = useMemo(
        () =>
            debounce(250, () => {
                ...
                // const {width: win_w, height: win_h} = window.screen;
                const win_w = window.innerWidth * 0.985;
                const win_h = window.innerHeight * 0.98;
                ...
                try {
                    console.log(`[React-Epub-Viewer] Resize: ${w} x ${h}`);
                    console.log(`[browser] Resize: ${win_w} x ${win_h}`);
                    console.log(`[margin] Resize: ${marginVertical}`);
                    console.log(`[scale] Resize: ${window.devicePixelRatio}`);
